...
<body>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="password" type="password" class="form-control"
                                                    id="currentPassword" placeholder="Masukkan kata sandi lama anda">
                                            </div>
                                        </div>

                                        <div class="row mb-3">
                                            <label for="newPassword" class="col-md-4 col-lg-3 col-form-label">Kata
                                                Sandi Baru</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="newpassword" type="password" class="form-control"
                                                    id="newPassword" placeholder="Masukkan kata sandi baru">
                                            </div>
                                        </div>

                                        <div class="row mb-3">
                                            <label for="renewPassword"
                                                class="col-md-4 col-lg-3 col-form-label">Konfirmasi Kata Sandi
                                                Baru</label>
                                            <div class="col-md-8 col-lg-9">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Aktifkan tab "Ganti Sandi" jika ada pesan sukses atau kesalahan
            var activeTab = '{{ session('activeTab') }}';
            if (activeTab === 'change-password') {
                var tabButton = document.querySelector('[data-bs-target="#profile-change-password"]');
