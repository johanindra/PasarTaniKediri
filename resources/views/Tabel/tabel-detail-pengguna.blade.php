        ...
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            @else
                <img src="{{ url('/Foto Profil User/defaultfoto.png') }}" alt="Default Profile"
                    class="rounded-circle profile-picture" style="width: 150px; height: 150px; object-fit: cover;"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    @if ($pengguna->foto_user)
                        <img src="{{ url('/Foto Profil User/' . $pengguna->foto_user) }}"
                            alt="{{ $pengguna->nama_user }}" class="img-fluid">
                    @else
                        <img src="{{ url('/Foto Profil User/defaultfoto.png') }}" alt="Default Profile"
                            class="img-fluid">
                    @endif
