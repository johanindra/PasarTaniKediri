<form action="{{ route('lengkapi-profil') }}" method="POST" enctype="multipart/form-data">
    ...
    @if (auth()->user()->hasRole(['kelompok_tani']))
        <div class="col-12">
            ...
            <input type="text" name="npwp" class="form-control @error('npwp') is-invalid @enderror" id="npwp"
                placeholder="Contoh: 01.234.567.8-123.000" value="{{ old('npwp', $user->npwp) }}" required>
        </div>
    @endif
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="kecamatan" name="kecamatan" required>
            ...
            <option value="Mojo" {{ old('kecamatan', $user->kecamatan_user ?? '') == 'Mojo' ? 'selected' : '' }}>Mojo
            </option>
            ...
            <option value="Kras" {{ old('kecamatan', $user->kecamatan_user ?? '') == 'Kras' ? 'selected' : '' }}>Kras
            </option>
            ...
            <option value="Pare" {{ old('kecamatan', $user->kecamatan_user ?? '') == 'Pare' ? 'selected' : '' }}>Pare
            </option>
            ...
            <option value="Papar" {{ old('kecamatan', $user->kecamatan_user ?? '') == 'Papar' ? 'selected' : '' }}>
                Papar</option>
            <option value="Pagu" {{ old('kecamatan', $user->kecamatan_user ?? '') == 'Pagu' ? 'selected' : '' }}>Pagu
            </option>
